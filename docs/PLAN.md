...
The agent picks the next open step, does it, updates the status here, commits, and stops when it needs you (🔑 / 👤) or at the end of a phase. To run one phase per conversation (cheaper), say: *"Do Phase 3 of the plan."*
...
| 🔑 CP-6 | 10.6 | *(optional)* Automatic deploys from GitHub |
